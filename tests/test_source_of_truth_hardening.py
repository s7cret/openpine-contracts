...
def test_release_metadata_is_5_0_0_rc3_everywhere() -> None:
    ...
    assert contracts.__version__ == "5.0.0rc3"
    assert "5.0.0-rc.3" in readme
    assert "5.0.0-rc.3" in adr
    assert 'openpine_contracts.__version__ == "5.0.0rc3"' in workflow
